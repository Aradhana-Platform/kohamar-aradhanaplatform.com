    ...
    <>
      ...
      <section className="container mx-auto py-24 px-6 bg-white">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-12 gap-4 max-w-7xl mx-auto">
          ...
          <Link
            href="/articles"
            className="group inline-flex items-center gap-2 ml-4 cursor-pointer px-3 py-1 rounded-md hover:bg-gray-100 hover:text-yellow-600 font-medium transition-colors self-start sm:self-auto"
          >
            View All Articles
            <svg
              className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1"
